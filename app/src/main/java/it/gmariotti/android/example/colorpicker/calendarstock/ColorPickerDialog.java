...
public class ColorPickerDialog extends DialogFragment
	...
	public static ColorPickerDialog newInstance(int titleResId, int[] colors,
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (savedInstanceState != null) {
			...
			mSelectedColor = (Integer) savedInstanceState
					.getSerializable(KEY_SELECTED_COLOR);
		}
	}
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		...
		View view = LayoutInflater.from(getActivity())
				.inflate(R.layout.calendar_color_picker_dialog, null);
		...
		mAlertDialog = new AlertDialog.Builder(activity).setTitle(mTitleResId)
				.setView(view).create();
